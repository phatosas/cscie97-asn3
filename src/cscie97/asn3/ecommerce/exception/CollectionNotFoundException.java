...
//        super( this.getClass().getName(),  + "occurred at line #" + lineNum + " of file " + filename + " in line number [" + lineNum + "]", cause);
//        super( this.getClass().getName(), line, lineNum, filename, cause);
