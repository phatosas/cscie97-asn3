...
/**
 * Exception for problems that the {@link cscie97.asn3.ecommerce.product.SearchEngine} may run into during typical
 * query execution.
 *
...
public class QueryEngineException extends Exception {
     ...
     * {@link cscie97.asn3.ecommerce.product.SearchEngine} class.  Arguments contain more specific details about
