...
/**
 * Abstract parent class for {@link cscie97.asn3.ecommerce.collection.Collection} and
 * {@link cscie97.asn3.ecommerce.collection.ContentProxy} objects.  Collectibles can contain child Collectibles,
 * which makes them a tree structure.  Because arbitrary numbers of child Collectibles can be added, the class
 * supports a {@link cscie97.asn3.ecommerce.collection.CollectionIterator} for iterating over all child elements.
 *
 * The object types that may be created that are children of the Collectible class are:
 * <ul>
 *     <li>{@link cscie97.asn3.ecommerce.collection.StaticCollection}</li>
 *     <li>{@link cscie97.asn3.ecommerce.collection.DynamicCollection}</li>
 *     <li>{@link cscie97.asn3.ecommerce.collection.ContentProxy}</li>
 * </ul>
 * All of these types will inherit their shared attributes ({@link cscie97.asn3.ecommerce.collection.Collectible#id},
 * {@link cscie97.asn3.ecommerce.collection.Collectible#name},
...
public abstract class Collectible {
    ...
    /**
     * Returns the current set of children {@link cscie97.asn3.ecommerce.collection.Collectible} objects that are
     * contained by this Collectible.  Note that while the children of the current Collectibles are all themselves
     * {@link cscie97.asn3.ecommerce.collection.Collectible} objects, their actual types may be one of:
     * <ul>
     *     <li>{@link cscie97.asn3.ecommerce.collection.ContentProxy} (used to wrap the
     *          {@link cscie97.asn3.ecommerce.product.Content} objects that get returned by the
     *          {@link cscie97.asn3.ecommerce.product.IProductAPI}</li>
     *     <li>{@link cscie97.asn3.ecommerce.collection.StaticCollection}</li>
     *     <li>{@link cscie97.asn3.ecommerce.collection.DynamicCollection}</li>
     * </ul>
     * Note that if the current Collectible is actually a {@link cscie97.asn3.ecommerce.collection.DynamicCollection},
     * this method will still return the found {@link cscie97.asn3.ecommerce.collection.ContentProxy} objects that
     * are found by executing the search (no need to separately execute the search).
     *
     * @return  the list of child {@link cscie97.asn3.ecommerce.collection.ContentProxy} objects contained in
