...
/**
 * Allows for the iteration of {@link cscie97.asn3.ecommerce.collection.Collectible} items.
 * {@link cscie97.asn3.ecommerce.collection.Collectible}s follow a two-part Composite design pattern; at the
 * lowest level, Collectibles can be instances of either {@link cscie97.asn3.ecommerce.collection.StaticCollection} or
 * {@link cscie97.asn3.ecommerce.collection.DynamicCollection}, both of which inherit from
 * {@link cscie97.asn3.ecommerce.collection.Collection}.  These {@link cscie97.asn3.ecommerce.collection.StaticCollection}
 * and {@link cscie97.asn3.ecommerce.collection.DynamicCollection} objects may be iterated over using this
 * CollectionIterator.  At a higher level, {@link cscie97.asn3.ecommerce.collection.Collectible}s may either be
 * {@link cscie97.asn3.ecommerce.collection.Collection} instances or
 * {@link cscie97.asn3.ecommerce.collection.ContentProxy} instances, and the two types share several common attributes.
 *
 * However, since {@link cscie97.asn3.ecommerce.collection.Collectible} objects may children of
 * {@link cscie97.asn3.ecommerce.collection.Collection}, they may have several children and at several layers of
...
public class CollectionIterator implements Iterator {
     ...
     * {@link cscie97.asn3.ecommerce.collection.Collectible} to be iterated over.
     *
