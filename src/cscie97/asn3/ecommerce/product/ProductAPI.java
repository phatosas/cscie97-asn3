 ...
 * {@link cscie97.asn3.ecommerce.product.Content} items as well as provides a search interface for that
 * {@link cscie97.asn3.ecommerce.product.Content}.
 *
 * Customers may use the API to search for {@link cscie97.asn3.ecommerce.product.Content} items and supply detailed
 * search criteria.  Application Developers and Administrators may use the API to add new
 * {@link cscie97.asn3.ecommerce.product.Content} items, new {@link cscie97.asn3.ecommerce.product.Country} items, and
 * new {@link cscie97.asn3.ecommerce.product.Device} by passing in filenames of CSV files with all data.  <b>Note that
 ...
 *
 * The {@link cscie97.asn3.ecommerce.product.ProductAPI} is a Singleton, so there is only ever one instance to use.
 * Additionally, the ProductAPI uses the Flyweight pattern to ensure that there is only ever one instance of each
 * {@link cscie97.asn3.ecommerce.product.Content}, {@link cscie97.asn3.ecommerce.product.Device}, and
...
public class ProductAPI implements IProductAPI {
     ...
     * maintains one unique instance of each {@link cscie97.asn3.ecommerce.product.Country} object (follows the
     ...
     * @param countries list of {@link cscie97.asn3.ecommerce.product.Country} objects to add to the product catalog
     */
     ...
     * {@link cscie97.asn3.ecommerce.product.Content} item has a list of supported {@link cscie97.asn3.ecommerce.product.Device}
     * objects that the content item may be downloaded onto.  The {@link cscie97.asn3.ecommerce.product.ProductAPI}
     * maintains one unique instance of each {@link cscie97.asn3.ecommerce.product.Device} object (follows the
     * Flyweight pattern).  Devices will be validated before being added to the product catalog; invalid devices
     * will be skipped over and not added.
     *
     * @param guid    a string token for a validated and authenticated user to allow restricted interface actions
     * @param devices list of {@link cscie97.asn3.ecommerce.product.Device} objects to add to the product catalog
     */
     ...
     * (content may be may be {@link cscie97.asn3.ecommerce.product.Application} items,
     * {@link cscie97.asn3.ecommerce.product.Ringtone} items, or {@link cscie97.asn3.ecommerce.product.Wallpaper}
     * items).  Each Content item in the product catalog is unique, so only one instance of each content item is
     * allowed (follows the Flyweight pattern).  {@link cscie97.asn3.ecommerce.product.Content} items will be validated
     * based on the {@link cscie97.asn3.ecommerce.product.ContentType} of each item before being added to the product
     * catalog; invalid content items will be skipped over and not added.
     *
     * @param guid         a string token for a validated and authenticated user to allow restricted interface actions
     * @param contentItems list of {@link cscie97.asn3.ecommerce.product.Content} objects to add to the product catalog
     */
     ...
     *
     * The search implicitly uses OR logic for determining if a {@link cscie97.asn3.ecommerce.product.Content} item
    ...
    /**
     * Given a device ID, search for any {@link cscie97.asn3.ecommerce.product.Device} that matches that code
    ...
    /**
     * Returns all {@link cscie97.asn3.ecommerce.product.Application} objects in the product catalog.
     *
     * @return all {@link cscie97.asn3.ecommerce.product.Application} objects in the product catalog
     */
    ...
    /**
     * Returns all {@link cscie97.asn3.ecommerce.product.Ringtone} objects in the product catalog.
     *
     * @return all {@link cscie97.asn3.ecommerce.product.Ringtone} objects in the product catalog
     */
    ...
    /**
     * Returns all {@link cscie97.asn3.ecommerce.product.Wallpaper} objects in the product catalog.
     *
     * @return all {@link cscie97.asn3.ecommerce.product.Wallpaper} objects in the product catalog
     */
    ...
    /**
     * Returns all {@link cscie97.asn3.ecommerce.product.Content} objects in the product catalog, regardless of
     * each individual item's content type (can include objects that are {@link cscie97.asn3.ecommerce.product.Application},
     * {@link cscie97.asn3.ecommerce.product.Ringtone}, or {@link cscie97.asn3.ecommerce.product.Wallpaper} types).
     *
     * @return all {@link cscie97.asn3.ecommerce.product.Content} objects in the product catalog regardless of type
     */
    ...
    /**
     * Returns all {@link cscie97.asn3.ecommerce.product.Country} objects in the product catalog.
     *
     * @return all {@link cscie97.asn3.ecommerce.product.Country} objects in the product catalog
     */
    ...
    /**
     * Returns all {@link cscie97.asn3.ecommerce.product.Device} objects in the product catalog.
     *
     * @return all {@link cscie97.asn3.ecommerce.product.Device} objects in the product catalog
     */
    ...
    /**
     * Convenience method that returns the total number of {@link cscie97.asn3.ecommerce.product.Content} items in
