...
/**
 * Represents a user search query of the {@link cscie97.asn3.ecommerce.product.IProductAPI} for
 * {@link cscie97.asn3.ecommerce.product.Content} items that match the criteria in the search object.  Since content
 * objects will be changing (adding new {@link cscie97.asn3.ecommerce.product.ContentType} in the future to add more
...
public class ContentSearch {
     ...
     * objects that get modified as the {@link cscie97.asn3.ecommerce.product.SearchEngine} loops over a CSV query
     * import file and constructs new ContentSearch objects for each unique search.
     */
    public ContentSearch() { }

    /**
     * Class constructor.  ContentSearch objects are created by the {@link cscie97.asn3.ecommerce.product.SearchEngine}
