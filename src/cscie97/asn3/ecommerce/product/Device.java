 ...
 * {@link cscie97.asn3.ecommerce.product.Content} items may be used with particular Devices.  Note that the
...
public class Device {
    ...
    /**
     * Since {@link cscie97.asn3.ecommerce.product.Device} objects may be added to collections, and also since
     * the {@link cscie97.asn3.ecommerce.product.IProductAPI} enforces that all device items be unique, this method
     * provides a way to determine if another {@link cscie97.asn3.ecommerce.product.Device} item is the same as the
     ...
     *
     * @param compare  the {@link cscie97.asn3.ecommerce.product.Device} item to compare to the current object to test for equality
